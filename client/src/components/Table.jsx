...
export default function Table() {
    ...
    function showSaveModalClickHandler(userId) {
        if (userId) {
    ...
    async function saveUserHandler(e, userEditId = null) {
        const formData = new FormData(e.target.form);
        const userInputData = Object.fromEntries(formData.entries());
        const userData = buildRequestData(userInputData);

        const user = userEditId 
            ? await userService.updateUser(userEditId,userData) 
    ...
    return (
        <>
                ...
                <table className="table">
                    ...
                    <tbody>
                        {users.map(user => <TableRow
                            ...
                            onEdit={showSaveModalClickHandler}
                        />
                        )}
                    </tbody>
                </table>
            ...
            <button className="btn-add btn" onClick={() => showSaveModalClickHandler()}>Add new user</button>
